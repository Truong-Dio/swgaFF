                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          20.0, 0.0, 20.0, 0.0),
                                      child: Text(
                                        'Exchange points during attend activity, event, campaign, games near by your. Bring your benefit to your home.',
                                        textAlign: TextAlign.center,
                                        maxLines: 3,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                          ...
                          children: [
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 16.0, 0.0, 320.0),
                              child: Image.asset(
                                'assets/images/Active-Kids-and-Creative-Kids-Voucher-Swap-Initiative.jpg',
                                width: double.infinity,
                                height: double.infinity,
                                fit: BoxFit.contain,
                              ).animateOnPageLoad(
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          20.0, 0.0, 20.0, 0.0),
                                      child: Text(
                                        'We source the suitable as possible as your favorite needs categorizes.',
                                        textAlign: TextAlign.center,
                                        maxLines: 2,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                          ...
                          children: [
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 16.0, 0.0, 320.0),
                              child: Image.asset(
                                'assets/images/game-development-concept-creative-process-vector-43873955.jpg',
                                width: double.infinity,
                                height: double.infinity,
                                fit: BoxFit.contain,
                              ).animateOnPageLoad(
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          20.0, 0.0, 20.0, 0.0),
                                      child: Text(
                                        'Mini-games designed in-app help you have fun during using app and get free points.',
                                        textAlign: TextAlign.center,
                                        maxLines: 2,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
