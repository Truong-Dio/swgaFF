                ...
                child: Padding(
                  ...
                  child: FutureBuilder<ApiCallResponse>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      final listViewApiCampaignGetAllGETResponse =
                          snapshot.data!;

                      return Builder(
                        builder: (context) {
                          final campaignListItem =
                              ItemsCampaignStruct.maybeFromMap(
                                          listViewApiCampaignGetAllGETResponse
                                              .jsonBody)
                                      ?.items
                                      .toList() ??
                                  [];
                                  ...
                                  children: [
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            highlightColor: Colors.transparent,
                                            onTap: () async {
                                              if (campaignListItemItem.id ==
                                                  'true') {
                                                FFAppState()
                                                    .updateDetaillistAtIndex(
                                                  campaignListItemIndex,
                                                  (e) => e..isFav = false,
                                                );
                                                safeSetState(() {});
                                              } else {
                                    ...
                                    Flexible(
                                      child: Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            12.0, 8.0, 8.0, 0.0),
                                        child: Text(
                                          campaignListItemItem.campaignName,
                                    ...
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          12.0, 4.0, 0.0, 0.0),
                                      child: Text(
                                        campaignListItemItem.brandName,
                                        maxLines: 1,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
