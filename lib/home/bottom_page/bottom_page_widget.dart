  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final bottomPageApiVoucherGETResponse = snapshot.data!;
          ...
          child: Scaffold(
            ...
            body: Column(
              ...
              children: [
                Padding(
                  padding:
                      EdgeInsetsDirectional.fromSTEB(20.0, 63.0, 20.0, 16.0),
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
                  ...
                  child: ListView(
                    ...
                    children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                context
                                    .pushNamed(CategoriesPageWidget.routeName);
                              },
                              child: Text(
                                'See All',
                                maxLines: 1,
                              ...
                              child: Row(
                                ...
                                children: List.generate(category.length,
                                  ...
                                  return InkWell(
                                    ...
                                    child: wrapWithModel(
                                      model:
                                          _model.categoryContainModels.getModel(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                context
                                    .pushNamed(JustForYouPageWidget.routeName);
                              },
                              child: Text(
                                'See All',
                                maxLines: 1,
                      ...
                      Padding(
                        ...
                        child: Builder(
                          builder: (context) {
                            final gridVoucher = VoucherListStruct.maybeFromMap(
                                        bottomPageApiVoucherGETResponse
                                            .jsonBody)
                                    ?.voucheritems
                                    .toList() ??
                                [];
